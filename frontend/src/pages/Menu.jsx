...
const imageMap = {
  "Amarula": Amarula, "ChickenSalad": ChickenSalad, "Beyaynetu": Beyaynetu,
  "BlackForest": BlackForest, "Tibs Delight": Tibs, "Salad": Salad,
  "Cocktail": Cocktail, "Velvet Chocolate Lava Cake": ChocolateLava,
  "Fish Cotelete": Fish, "Doro Wot": Doro, "Soufflé": Sufle,
  "Mohjhito": Mojhito, "Kitfo": Kitfo, "Tiramisu": Tiramisu,
  "Ocean Symphony Risotto": OceanSymphony, "Tej": Tej
};
  ...
  return (
    <section className="menu-hero">
      ...
      <div className="hero-container">
        <h1 className="hero-title">Discover, Select, Enjoy – Your <br /> Perfect Choice Awaits</h1>
        <div className="hero-main-content">
          <div className="badge-wrapper">
            <div className="quality-card">
              <div className="badge-icon-bg"><span className="icon">🍲</span></div>
              <p><strong>100% Organic Foods</strong></p>
              <small>A meal you will never forget</small>
            </div>
          </div>
          <div className="hero-dish-container">
            <img src={Tibs} alt="Hero Dish" className="main-hero-img" />
          </div>
          <div className="hero-info-side">
            <p className="hero-description">Explore our diverse menu, carefully curated for every taste.</p>
            <div className="hero-action-btns">
              <Button text="View Menu" variant="yellow" onClick={() => document.getElementById("full-menu")?.scrollIntoView({ behavior: "smooth" })} />
    ...
    <section className="full-menu-section" id="full-menu">
      <div className="section-container">
        <div className="full-menu-header">
          <h2 className="full-menu-title">Savor the Flavor, Delight <br /> in Every Bite!</h2>
